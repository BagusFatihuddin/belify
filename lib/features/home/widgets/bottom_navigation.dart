  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildNavItem(
            icon: SvgIcon.home(color: const Color(0xFF156651)),
            label: 'Home',
            isActive: true,
            onTap: () async {
          ...
          _buildNavItem(
            icon: SvgIcon.user(color: const Color(0xFFC2C2C2)),
            label: 'My Account',
            isActive: false,
            onTap: () async {
              final prefs = await SharedPreferences.getInstance();
...
// import 'package:belify/features/profil/screen/account_screen.dart';
// import 'package:belify/features/cart/screens/cart_screen.dart';
// import 'package:belify/features/home/screen/home_screen.dart';
// import 'package:belify/features/crud_user/screen/get_user_screen.dart';
// import 'package:flutter/material.dart';
// import 'package:shared_preferences/shared_preferences.dart';
